...
public class TestWithWitnessSummary : Summary<TestWithWitnessEndpoint>
{
    public TestWithWitnessSummary()
    {
        Summary = "Test primality of an integer using a specified witness number less than the integer to test";
